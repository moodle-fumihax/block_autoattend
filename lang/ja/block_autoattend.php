...
$string['attendgpercent'] = '得点率';
$string['attendnpercent'] = '出席率';
...
$string['email_teacher_key_html'] = '{$a->fullname} [{$a->date} {$a->starttm}-{$a->endtm}] の出欠キーワードは <div style="font-weight:bold;">{$a->key}</div> です．';
...
$string['settingpairmod']  = '<div style="font-weight:bold;">モジュール (mod_autoattedmod) の設定</div>';
$string['instancepairmod'] = '<div style="font-weight:bold;">このコースにモジュール (mod_autoattendmod) のインスタンスを作成してください</div>';
$string['installpairmod']  = '<div style="font-weight:bold;">モジュール (mod_autoattendmod) をインストールしてください</div>';
...
$string['deletedb_info'] = '<div style="font-weight:bold;">{$a->delstr}</div> 以前の削除対象の授業データは <div style="font-weight:bold;">{$a->delnum}</div>個 です．';
